...
# relationship_types = [
#     'CAREER_START', 'ACTED_IN_YEAR',
#     'DIRECTED_BY', 'DIRECTED' 'STARRED_BY', 'RELEASE_DATE', 'STARRED_IN', 'GAINED_FAME_IN', 'DEBUTED_IN', 'GAINED_RECOGNITION_WITH', 'COMMERCIAL_SUCCESS_WITH', 'ACTED_IN', 'KNOWN_AS',
#         'GAINED_FAME_THROUGH', 'FEATURES']
